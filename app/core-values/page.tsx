  ...
  return (
    <div className="bg-white">
      ...
      <main className="mx-auto font-[lato] px-2 lg:px-0  lg:w-[80%]">
        <h2 className="text-xl mb-1 mt-3 font-bold">Customer Focus</h2>
        ...
        <h2 className="text-xl mb-1 font-bold">Integrity </h2>
        <p className="text-base">
        ...
        <h2 className="text-xl mb-1 font-bold">Teamwork </h2>
        ...
        <h2 className="text-xl mb-1 font-bold">Professionalism </h2>
